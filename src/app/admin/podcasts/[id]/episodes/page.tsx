      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href={`/admin/podcasts/${id}/episodes/new`}>
                <Button className="bg-red-600 hover:bg-red-700 text-white rounded-full">
                  Add Episode
                </Button>
              </Link>
              <Link href={`/admin/podcasts/${id}/edit`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-modern-lg shadow-modern border border-gray-200">
              ...
              <div className="divide-y divide-gray-200">
                {episodes.length === 0 ? (
                  <div className="p-12 text-center">
                    ...
                    <p className="text-gray-600 mb-6">This podcast doesn&apos;t have any episodes yet.</p>
                    <Link href={`/admin/podcasts/${id}/episodes/new`}>
                      <Button className="bg-red-600 hover:bg-red-700 text-white rounded-full">
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center space-x-3 mb-3">
                            <span className="inline-flex items-center justify-center h-8 w-8 bg-red-600 text-white text-sm font-medium rounded-full">
                        ...
                        <div className="ml-6 flex items-center space-x-2">
                          ...
                          <Link href={`/admin/podcasts/${id}/episodes/${episode.id}/edit`}>
