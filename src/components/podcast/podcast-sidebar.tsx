  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-8 pt-8">
        <h3 className="text-2xl font-bold text-gray-900 mb-3">🏛️ Licensing Information</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-bold text-gray-900">Copyright Terms</h3>
          </div>
          <div className="space-y-3">
            <div className="bg-gray-50 rounded-lg p-3 border border-gray-100">
              <div className="text-gray-600 text-xs mb-1">License Duration</div>
              <div className="text-gray-900 font-semibold text-sm">Lifetime + 70 years</div>
            </div>
            <div className="bg-gray-50 rounded-lg p-3 border border-gray-100">
              <div className="text-gray-600 text-xs mb-1">Content Rights</div>
              <div className="text-gray-900 font-semibold text-sm">Full Commercial Use</div>
            </div>
            <div className="bg-gray-50 rounded-lg p-3 border border-gray-100">
              <div className="text-gray-600 text-xs mb-1">Territory</div>
              <div className="text-gray-900 font-semibold text-sm">Worldwide</div>
            </div>
          </div>
        </div>

        {/* Content Package Card */}
        <div className="bg-white rounded-xl shadow-lg p-6 border border-blue-200 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-bold text-gray-900">Content Package</h3>
          </div>
          <div className="space-y-3">
            <div className="flex items-center py-1">
              <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
              <span className="text-gray-700 text-sm">High-quality audio files (320kbps)</span>
            </div>
            <div className="flex items-center py-1">
              <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
              <span className="text-gray-700 text-sm">Complete episode scripts</span>
            </div>
            <div className="flex items-center py-1">
              <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
              <span className="text-gray-700 text-sm">Metadata & show notes</span>
            </div>
            <div className="flex items-center py-1">
              <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
              <span className="text-gray-700 text-sm">Cover art & branding</span>
            </div>
            <div className="flex items-center py-1">
              <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
              <span className="text-gray-700 text-sm">Professional production</span>
            </div>
          </div>
        </div>

        {/* Demographics Card */}
        <div className="bg-white rounded-xl shadow-lg p-6 border border-green-200 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center mb-4">
          ...
          <div className="space-y-3">
            <div className="bg-green-50 rounded-lg p-3 border border-green-100">
              <div className="text-green-700 text-xs mb-1">Total Listeners</div>
              <div className="text-gray-900 font-semibold text-sm">150K+ per launch</div>
            </div>
            <div className="bg-green-50 rounded-lg p-3 border border-green-100">
              <div className="text-green-700 text-xs mb-1">Per Episode</div>
              <div className="text-gray-900 font-semibold text-sm">5K+ average</div>
            </div>
            <div className="bg-green-50 rounded-lg p-3 border border-green-100">
              <div className="text-green-700 text-xs mb-1">Age Groups</div>
              <div className="text-gray-900 font-semibold text-sm">25-45 (70%)</div>
            </div>
          </div>
        </div>
      </div>
